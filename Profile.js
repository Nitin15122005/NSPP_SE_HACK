...
export default function Profile({ navigation }) {
  ...
  // Mood data with quotes and habit suggestions
  const moodData = {
    happy: {
      emoji: '😊',
    ...
    excited: {
      emoji: '🤩',
      quote: "Excitement is the electricity of life. Use it to power your dreams!",
      habits: [
        "Start a new project",
        "Set ambitious goals",
        ...
        <View style={styles.profileSection}>
          ...
          <View style={styles.moodSection}>
            ...
            <View style={styles.moodIcons}>
              ...
              <TouchableOpacity onPress={() => handleMoodPress('content')}>
                <View style={[styles.moodIconContainer, { backgroundColor: '#FF950020' }]}>
                  <Text style={styles.moodEmoji}>😋</Text>
                </View>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => handleMoodPress('excited')}>
              ...
              {selectedMood && (
                <>
                  <Text style={[styles.popupTitle, { color: theme.text }]}>
                    {moodData[selectedMood].emoji} Mood Activated!
                  </Text>
                  <Text style={[styles.popupQuote, { color: theme.secondaryText }]}>
                    "{moodData[selectedMood].quote}"
                  </Text>
                  
                  <Text style={[styles.suggestedHabitsTitle, { color: theme.text }]}>
                    Suggested Habits:
                  </Text>
                  
                  {moodData[selectedMood].habits.map((habit, index) => (
                    <View key={index} style={styles.habitSuggestion}>
                      <View style={[styles.habitBullet, { backgroundColor: moodData[selectedMood].color }]} />
          ...
          <View style={styles.scoresSection}>
            ...
            <View style={styles.scoreCircleContainer}>
              ...
              <View style={styles.scoreTextContainer}>
                <Text style={[styles.scoreValue, { color: theme.text }]}>{userData.score}%</Text>
              </View>
            </View>
          </View>
        )}
