...
const actionHabits = [
  { id: '1', emoji: '🏋️‍♂️', title: 'Workout', time: '0 / 3 sets' },
  { id: '2', emoji: '💼', title: 'Crush Work Tasks', time: '0 / 5 tasks' },
  { id: '3', emoji: '🧹', title: 'Clean Room', time: '0 / 1 area' },
  { id: '4', emoji: '📈', title: 'Plan the Day', time: '0 / 1 session' },
  { id: '5', emoji: '🍳', title: 'Cook a Meal', time: '0 / 1 meal' },
  { id: '6', emoji: '🚿', title: 'Cold Shower', time: '0 / 1 done' },
];

const growthHabits = [
  { id: 'a1', emoji: '🧘‍♀️', title: 'Meditate', time: '0 / 15 min' },
  { id: 'a2', emoji: '📓', title: 'Journal', time: '0 / 1 entry' },
  { id: 'a3', emoji: '📖', title: 'Read a Book', time: '0 / 20 min' },
  { id: 'a4', emoji: '🌳', title: 'Nature Walk', time: '0 / 30 min' },
  { id: 'a5', emoji: '💖', title: 'Practice Gratitude', time: '0 / 3 things' },
  { id: 'a6', emoji: '📵', title: 'Digital Detox', time: '0 / 1 hr' },
];
...
export default function ActionScreen() {
  ...
  const habits = mode === 'growth'
    ? [...growthHabits, ...customHabits.filter((h) => h.mode === 'growth')]
    : [...actionHabits, ...customHabits.filter((h) => h.mode === 'action')];
